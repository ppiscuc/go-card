...
func SelectByNameCommand(aid ...byte) CommandAPDU {
	return Command3(0x00, 0xa4, 0x04, 0x00, aid)
}

// SelectByFile selects a file based on it's path
func SelectByPathCommand(aid ...byte) CommandAPDU {
	return Command3(0x00, 0xa4, 0x08, 0x00, aid)
}
